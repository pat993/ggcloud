...
<div style="max-width: 600px; margin: auto" class="page-content header-clear-medium">
   ...
   <div class="card card-style preload-img mb-2" data-src="images/ragnarok-x.jpg" data-card-height="150">
      <div class="card-center ms-3">
         <h1 class="color-white mb-0">My Device</h1>
                  ...
                  <div data-card-height="180" class="card mx-3 rounded-m shadow-l card-style preload-img" data-src="images/android.jpg">
                     <div class="card-bottom ms-3 mb-3" style="color: white">
                        ...
                        <div class="progress mt-0 mb-1" style="height:3px; width: 40px">
                           <div class="progress-bar border-0 bg-red-dark text-start ps-1" role="progressbar" style="width: <?= $jam_percent; ?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="<?= $dur_jam; ?>">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="card-top ms-3 mt-3">
                        <h3 class="color-white font-900 mb-0"><?= $device['custom_name']; ?></h3>
                        <!-- <p class="color-white font-11 mt-n1 mb-2">Android 8, Octa-core, 4GB RAM, 64GB ROM</p> -->
                     </div>

                     <div class="card-top me-4 mt-3">
                        <button class="color-white font-900 mb-0 float-end" data-menu="menu-device-info-" . <?= $device['id'] ?> . ""><i class="fas fa-ellipsis-v"></i></button>
                     </div>
                     <!-- <div class="card-top">
...
?>
   <div id="menu-device-info-" . <?= $result['id'] ?> . "" class="menu menu-box-modal rounded-m" style="max-width: 600px; width: 100%">
      <div class="menu-title">
         <h1>
            <i class="fab fa-android"></i> Device Info <button class="close-menu float-right me-4 opacity-50"><i class="fa fa-times"></i></button>
         </h1>
      </div>
            ...
            <table class="table table-borderless table-striped rounded-sm shadow-xs mb-0" style="overflow: hidden;" id="tb_device">
               <tr>
                  ...
                  <td style="position: relative;"><?= $result["custom_name"]; ?>
                     <i data-menu="menu-edit-device" . <?= $result['id'] ?> . "" style="position:absolute; right:15px" class="fas fa-pencil-alt"></i>
                  </td>
               </tr>
               <tr>
                  <td style="width: 150px">
